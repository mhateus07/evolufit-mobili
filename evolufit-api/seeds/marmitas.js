...
async function seed() {
    ...
    for (const m of marmitas) {
        await db.query(`INSERT INTO marmitas (name, description, calories, protein_g, carbs_g, fat_g, price_cents, tags)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
       ON CONFLICT DO NOTHING`, [m.name, m.description, m.calories, m.protein_g, m.carbs_g, m.fat_g, m.price_cents, m.tags]);
        console.log(`  ✅ ${m.name}`);
    }
...
//# sourceMappingURL=marmitas.js.map